...
export default function FAQ() {
    ...
    return (
        <section className=" relative top-0 w-full h-[170vh] font-['Apris','Times_New_Roman',sans-serif] overflow-hidden  overflow-hidden">
            {/* white grid lines */}
            <div className="absolute top-30 bottom-20 left-10 right-10 inset-0  grid grid-cols-4 grid-rows-2 ">
            ...
            {/* page2 */}
            <section className="absolute top-11 lg:top-24">
                <div className=" flex flex-col lg:ml-83 ">
                    <h1 className="text-[60px] lg:ml-61 mb-7">
                        FAQ
                    </h1>
                    ...
                    {faqs.map((item, index) => (
                        ...
                        <div
                            key={index}
                            className="border-b border-[#cfc7be] py-5 w-[350px] ml-5 lg:ml-0 lg:w-[590px] mx-auto"
                        >
                            ...
                            >
                                ...
                                <h2 className="text-[20px] text-[#3d2a1f]">
                                    {item.question}
                                </h2>
